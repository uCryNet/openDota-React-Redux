...
export default function About() {
  return (
    <div className={style.wrapper}>
      ...
      <p>
        Я не особо парился над стилями и не ставил себе за цель скопировать полностью функционал <b><a
        href="https://www.opendota.com/" target="_blank" rel="noopener noreferrer">opendota.com</a></b>.
      </p>
